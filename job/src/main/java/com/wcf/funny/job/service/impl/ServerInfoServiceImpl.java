...
import com.wcf.funny.job.constant.JobConstant;
import com.wcf.funny.job.constant.TaskInterval;
import com.wcf.funny.job.entity.ServerInfo;
import com.wcf.funny.job.exception.errorcode.ServerInfoErrorCode;
import com.wcf.funny.job.mapper.ServerInfoMapper;
import com.wcf.funny.job.service.ServerInfoService;
import com.wcf.funny.job.vo.ServerChartVo;
import com.wcf.funny.job.vo.ServerInfoVo;
...
public class ServerInfoServiceImpl implements ServerInfoService {
    ...
    public void insertServerInfo(String type) {
        ...
        getMetricStatistic(JobConstant.SYSTEM_CPU_USED, null);
    ...
    public String cpuUsed() {
        Double used = getMetricStatistic(JobConstant.SYSTEM_CPU_USED, null);
    ...
    public String diskUsed() {
        Health health = healthEndpoint.healthForComponent(JobConstant.DISK_SPACE);
    ...
    public String noHeapUsed() {
        ...
        Double used = getMetricStatistic(JobConstant.JVM_MEMORY_USED, tag);
