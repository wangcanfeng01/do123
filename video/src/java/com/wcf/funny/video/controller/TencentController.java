...
public class TencentController {
    ...
    public BaseResponse<VideoHomeVo> videoHome() {
        ...
        vo.setCarousels(cacheService.varietyShow(client));
        vo.setCarousels(cacheService.tvHots(client));
        vo.setCarousels(cacheService.cartoons(client));
        vo.setCarousels(cacheService.movies(client));
